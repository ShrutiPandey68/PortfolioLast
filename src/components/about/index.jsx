      ...
      <div className="grid grid-cols-12 gap-4 xs:gap-6 md:gap-8 w-full">
        <ItemLayout className="col-span-full lg:col-span-8 row-span-2 flex-col items-start">
          ...
          <p className="font-light text-xs sm:text-sm md:text-base">
            I am Shruti Pandey, a passionate software engineer with over 3 years
        ...
        <ItemLayout className="col-span-full sm:col-span-12 md:col-span-8 !p-0">
          <Image
        ...
        <ItemLayout className="col-span-full xs:col-span-12 lg:col-span-12 text-accent">
          <p className="font-semibold w-full text-left text-2xl sm:text-5xl">
            Worked On Many{" "}
            <sub className="font-semibold text-base"></sub>
          </p>
